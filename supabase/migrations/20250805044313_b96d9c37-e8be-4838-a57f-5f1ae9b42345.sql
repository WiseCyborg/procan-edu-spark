-- Phase 1: Critical Database Fixes (Fixed JSON syntax)
...
(
  ...
  '[
    ...
    },
    {
      ...
      "explanation": "The Maryland Medical Cannabis Commission (MMCC) is responsible for regulating the medical cannabis program."
    }
  ]'::jsonb,
  true
),
(
  ...
  '[
    ...
    },
    {
      ...
      "explanation": "Patient medical information can only be shared with written consent from the patient."
    }
  ]'::jsonb,
  true
),
(
  ...
  '[
    ...
    },
    {
      ...
      "explanation": "Edible cannabis products typically take 30-90 minutes to take effect."
    }
  ]'::jsonb,
  true
),
(
  ...
  'Learn about Maryland seed-to-sale tracking requirements, inventory management best practices, and compliance with state tracking systems.',
  '[
    {
      "question": "What system does Maryland use for seed-to-sale tracking?",
      "options": ["METRC", "BioTrackTHC", "Leaf Data Systems", "MJ Freeway"],
      "correct": "METRC",
      "explanation": "Maryland uses METRC for seed-to-sale tracking."
    }
  ]'::jsonb,
  true
),
  ...
  '[
    {
      ...
      "explanation": "Intoxicated customers should not be served cannabis products."
    }
  ]'::jsonb,
  true
);