-- Fix registration URL generation in approve_dispensary_application function
CREATE OR REPLACE FUNCTION public.approve_dispensary_application(application_id uuid, credits integer DEFAULT NULL::integer, calling_user_id uuid DEFAULT NULL::uuid)
...
BEGIN
  ...
  -- FIXED: Use correct domain and path
