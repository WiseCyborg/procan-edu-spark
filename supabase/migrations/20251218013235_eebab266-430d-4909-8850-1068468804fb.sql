...
-- Fix the get_approved_organizations function to use correct column names
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(da.contact_person, p.full_name, o.contact_person, 'Not assigned') AS manager_name,
