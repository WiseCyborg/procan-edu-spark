...
export const InvestmentValueCard = () => {
  const features = [
    ...
    {
      title: '1-Year Certificate',
      description: 'Digital certificate valid for 1 year with verification',
      ...
      <CardHeader className="text-center pb-4">
        <CardTitle className="text-2xl md:text-3xl text-foreground">
          {CHECKOUT_ENABLED
            ...
            : "What's Included in ProCann Edu Workforce Education"}
        </CardTitle>
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">
                  {CHECKOUT_ENABLED ? 'Investment: $49.99' : 'Contact us about workforce education'}
                </strong>
              </p>
