...
const EnhancedCourseModule: React.FC = () => {
  ...
  const videoLoadErrorEmittedRef = React.useRef<string | null>(null);
  useEffect(() => {
    if (!moduleData?.asset_key || moduleData.video_pending) return;
    if (signedVideoData?.success !== false) return;
    const key = `${moduleData.id}:${moduleData.asset_key}`;
  ...
  const modulesWithCompletion = useMemo(() => [
    ...
    { id: 'b8d16c7f-10e6-40d5-b766-721839038f5e', number: 2, title: 'Age Verification and ID Checking', tier: 'green' as const, isCompleted: isModuleCompletedByNumber(2), isLocked: !canAccessModule(2) },
    { id: '3b7d23c0-c7d9-48ea-ac75-17e515e6304a', number: 3, title: 'Patient Rights and Privacy', tier: 'green' as const, isCompleted: isModuleCompletedByNumber(3), isLocked: !canAccessModule(3) },
    ...
    { id: '7c10652a-202b-459a-b02c-9020906b1888', number: 11, title: 'Medical Cannabis and Drug Interactions', tier: 'yellow' as const, isCompleted: isModuleCompletedByNumber(11), isLocked: !canAccessModule(11) },
    { id: 'f2eaecb3-603b-4f9e-90ea-254f57774b8f', number: 12, title: 'Cannabis Cultivation Basics', tier: 'yellow' as const, isCompleted: isModuleCompletedByNumber(12), isLocked: !canAccessModule(12) },
    { id: 'f39ac55c-6ee4-4a49-a739-8a0bb6869fc8', number: 13, title: 'Product Packaging, Labeling, and Diversion Prevention', tier: 'red' as const, isCompleted: isModuleCompletedByNumber(13), isLocked: !canAccessModule(13) },
    { id: '3f0bad34-49ef-4ed7-8ade-6785dd35719a', number: 14, title: 'Handling Cash and Banking', tier: 'red' as const, isCompleted: isModuleCompletedByNumber(14), isLocked: !canAccessModule(14) },
